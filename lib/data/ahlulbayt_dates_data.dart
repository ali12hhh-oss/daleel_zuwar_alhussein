...
const List<AhlulBaytEvent> ahlulBaytEvents = [
  ...
  AhlulBaytEvent(
    ...
    description: 'توفي صلى الله عليه وآله في المدينة المنورة؛ وتذكر بعض الروايات أنه دُسّ له السمّ في خيبر قبل ذلك بأثر متأخر.',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'ولد عليه السلام داخل الكعبة المشرفة بحسب الرواية المشهورة.',
    source: 'إعلام الورى، بحار الأنوار',
  ),
  AhlulBaytEvent(
    personName: 'الإمام علي بن أبي طالب عليه السلام',
    ...
    description: 'استشهد عليه السلام إثر ضربة سيف من عبد الرحمن بن ملجم لعنة الله عليه وهو يصلي صلاة الفجر في مسجد الكوفة، بعد أن ضُرب ليلة 19 رمضان وبقي بين الحياة والموت يومين.',
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في المدينة المنورة على يد زوجته جعدة للعنة الله عليها بتحريض من معاوية بن أبي سفيان لعنهم الله بحسب الروايات الشيعية.',
    source: 'بحار الأنوار، إعلام الورى',
  ),
  ...
  AhlulBaytEvent(
    ...
    narrations: [
      Narration(
        ...
        hijriYear: '61 هـ',
        attributedTo: ' (اللهوف، بحار الأنوار)',
        isMostFamous: true,
      ),
    ],
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في المدينة المنورة بأمر الوليد بن عبد الملك، عليه اللعنة بحسب الروايات الشيعية.',
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في المدينة المنورة بأمر هشام بن عبد الملك، عليه العنة بحسب الروايات الشيعية.',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في المدينة المنورة بأمر المنصور الدوانيقي عبيه اللعنة، بحسب الروايات.',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في سجن هارون الرشيد عبيه لعائن الله ببغداد على يد السندي بن شاهك لعنه الله، بحسب الروايات.',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في مدينة طوس (مشهد المقدسة حالياً) بأمر المأمون العباسي عليه اللعنة، بحسب الروايات .',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في بغداد على يد زوجته أم الفضل بتحريض من المعتصم العباسي عيه اللعنة، بحسب الروايات .',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في مدينة سامراء بأمر المعتز العباسي عليه اللعنة، بحسب الروايات .',
    source: 'بحار الأنوار',
  ),
  ...
  AhlulBaytEvent(
    ...
    description: 'استشهد عليه السلام مسموماً في مدينة سامراء بأمر المعتمد العباسي عليه اللعنة، بحسب الروايات .',
    source: 'بحار الأنوار',
  ),
